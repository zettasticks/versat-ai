...
// AXI bus to connect SoC to interconnect
    wire [AXI_ADDR_W-1:0] s_axi_araddr;
    wire s_axi_arvalid;
    wire s_axi_arready;
    ...
    wire s_axi_rvalid;
    wire s_axi_rready;
    wire [AXI_ID_W-1:0] s_axi_arid;
    wire [AXI_LEN_W-1:0] s_axi_arlen;
    ...
    wire s_axi_rlast;
    wire [AXI_ADDR_W-1:0] s_axi_awaddr;
    wire s_axi_awvalid;
    wire s_axi_awready;
    wire [AXI_DATA_W-1:0] s_axi_wdata;
    wire [AXI_DATA_W/8-1:0] s_axi_wstrb;
    wire s_axi_wvalid;
    wire s_axi_wready;
    wire [2-1:0] s_axi_bresp;
    wire s_axi_bvalid;
    wire s_axi_bready;
    wire [AXI_ID_W-1:0] s_axi_awid;
    wire [AXI_LEN_W-1:0] s_axi_awlen;
    ...
    wire m_axi_arvalid;
    wire m_axi_arready;
    wire [MEM_DATA_W-1:0] m_axi_rdata;
