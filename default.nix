...
let
  py2hwsw_commit = "96c6b99d35513a98d4a1cc7f63a76c7872d70a7d"; # Replace with the desired commit.
  py2hwsw_sha256 = "ERpoB+vNZdbr+IzubDxY3YATcV2henBMCyWftdTu2pU="; # Replace with the actual SHA256 hash.
