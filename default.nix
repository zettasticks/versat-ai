...
let
  py2hwsw_commit = "9ab697dc1106d75c553ef3433f585e586c08efa8"; # Replace with the desired commit.
  py2hwsw_sha256 = "rnnI0GlSYDygCwPuBjC7nKy9s7ACf04iw0UYB+nWmFg="; # Replace with the actual SHA256 hash.
